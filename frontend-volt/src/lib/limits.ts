// Keep in sync with the backend LIMITS
...
export const LIMITS = {
  ...
  EQUIPMENT_MAX: 50, // open-ended vocab
  CATEGORY_MAX: 50, // open-ended vocab
  ...
  // User goals
  TARGET_WEIGHT_MAX: 1000, // lbs, mirror BODY_WEIGHT_MAX
